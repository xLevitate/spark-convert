    ...
    <main className="flex-1 container mx-auto px-4 py-12" role="main">
      <div className="text-center mb-16 space-y-4">
        ...
        <p className="text-gray-400 max-w-2xl mx-auto text-lg">
          Free, open-source file conversion for everyone. No ads, no signups, no nonsense.
      ...
      <div className="mt-24 grid md:grid-cols-3 gap-8 relative">
        ...
        <div className="glass-card rounded-lg p-8 text-center hover-card">
          ...
          <p className="text-gray-400">No hidden costs or limitations. Convert files freely and check out our code on GitHub.</p>
        </div>
        ...
        <div className="glass-card rounded-lg p-8 text-center hover-card">
          ...
          <p className="text-gray-400">All conversions happen in your browser. Your files never leave your device.</p>
        </div>
        ...
        <div className="glass-card rounded-lg p-8 text-center hover-card">
          ...
          <p className="text-gray-400">Support for various file formats with more being added regularly.</p>
        </div>
      </div>
    </main>
  );
